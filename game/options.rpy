...
define config.version = "version2.0"
...
define gui.about = _p("""
    喜欢石头门这部动漫，带给我很大的震撼，
    本人是做web前后端的，对游戏开发领域没有什么了解，
    于是通过renpy+纯python代码，结合chatgpt搭建了这么一个模拟Amadeus系统的小游戏，算是对命运石之门这部动漫表达出我的喜爱吧！
""")
...
define config.save_directory = "AmadeusUI-1675324611"
...
define config.window_icon = "gui/logo_icon.png"
